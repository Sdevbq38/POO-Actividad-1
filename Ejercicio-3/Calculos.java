...
public class Calculos {
    public static double calcular_salario_bruto(double horaslaboradas, double valorhora){
        double salario_bruto = horaslaboradas * valorhora;
        return salario_bruto;
    }
    
    public static double calcular_retefuente(double horaslaboradas, double valorhora, double porcentajeretencion){
