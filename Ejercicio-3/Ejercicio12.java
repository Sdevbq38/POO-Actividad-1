...
public class Ejercicio12 {
    ...
    public static void main(String[] args) {
        ...
        salario_bruto = Calculos.calcular_salario_bruto(horaslaboradas, valorhora);
        retefuente = Calculos.calcular_retefuente(horaslaboradas, valorhora, porcentajeretencion); 
